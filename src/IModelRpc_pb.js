...
$root.RequestWrapper = (function () {
  ...
  Object.defineProperty(RequestWrapper.prototype, "msg", {
    get: $util.oneOfGetter(
      ($oneOfFields = [
        "selectElementIdsRequest",
        "exportMeshesRequest",
        "textureRequest",
        "elementTooltipRequest",
        "projectExtentsRequest",
        "cameraViewsRequest",
  ...
  RequestWrapper.encode = function encode(message, writer) {
    ...
    if (
      message.selectElementIdsRequest != null &&
      Object.hasOwnProperty.call(message, "selectElementIdsRequest")
    )
      $root.SelectElementIdsRequest.encode(
        message.selectElementIdsRequest,
        writer.uint32(/* id 2, wireType 2 =*/ 18).fork()
      ).ldelim()
    if (
      message.exportMeshesRequest != null &&
      Object.hasOwnProperty.call(message, "exportMeshesRequest")
    )
      $root.ExportMeshesRequest.encode(
        message.exportMeshesRequest,
        writer.uint32(/* id 3, wireType 2 =*/ 26).fork()
      ).ldelim()
    if (
      message.textureRequest != null &&
      Object.hasOwnProperty.call(message, "textureRequest")
    )
      $root.TextureRequest.encode(
        message.textureRequest,
        writer.uint32(/* id 4, wireType 2 =*/ 34).fork()
      ).ldelim()
    if (
      message.elementTooltipRequest != null &&
      Object.hasOwnProperty.call(message, "elementTooltipRequest")
    )
      $root.ElementTooltipRequest.encode(
        message.elementTooltipRequest,
        writer.uint32(/* id 5, wireType 2 =*/ 42).fork()
      ).ldelim()
    if (
      message.projectExtentsRequest != null &&
      Object.hasOwnProperty.call(message, "projectExtentsRequest")
    )
      $root.ProjectExtentsRequest.encode(
        message.projectExtentsRequest,
        writer.uint32(/* id 6, wireType 2 =*/ 50).fork()
      ).ldelim()
    if (
      message.cameraViewsRequest != null &&
      Object.hasOwnProperty.call(message, "cameraViewsRequest")
    )
      $root.CameraViewsRequest.encode(
        message.cameraViewsRequest,
        writer.uint32(/* id 7, wireType 2 =*/ 58).fork()
      ).ldelim()
    if (
      message.elementPropertiesRequest != null &&
      Object.hasOwnProperty.call(message, "elementPropertiesRequest")
    )
      $root.ElementPropertiesRequest.encode(
  ...
  RequestWrapper.decode = function decode(reader, length) {
    ...
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.RequestWrapper()
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.selectElementIdsRequest =
            $root.SelectElementIdsRequest.decode(reader, reader.uint32())
          break
        case 3:
          message.exportMeshesRequest = $root.ExportMeshesRequest.decode(
            reader,
            reader.uint32()
          )
          break
        case 4:
          message.textureRequest = $root.TextureRequest.decode(
            reader,
            reader.uint32()
          )
          break
        case 5:
          message.elementTooltipRequest = $root.ElementTooltipRequest.decode(
            reader,
            reader.uint32()
          )
          break
        case 6:
          message.projectExtentsRequest = $root.ProjectExtentsRequest.decode(
            reader,
            reader.uint32()
          )
          break
        case 7:
          message.cameraViewsRequest = $root.CameraViewsRequest.decode(
            reader,
            reader.uint32()
          )
          break
        case 8:
          message.elementPropertiesRequest =
            $root.ElementPropertiesRequest.decode(reader, reader.uint32())
          break
        default:
  ...
  RequestWrapper.verify = function verify(message) {
    ...
    if (
      message.selectElementIdsRequest != null &&
      message.hasOwnProperty("selectElementIdsRequest")
    ) {
      properties.msg = 1
      {
        var error = $root.SelectElementIdsRequest.verify(
          message.selectElementIdsRequest
        )
        if (error) return "selectElementIdsRequest." + error
      }
    }
    if (
      message.exportMeshesRequest != null &&
      message.hasOwnProperty("exportMeshesRequest")
    ) {
      if (properties.msg === 1) return "msg: multiple values"
      properties.msg = 1
      {
        var error = $root.ExportMeshesRequest.verify(
          message.exportMeshesRequest
        )
        if (error) return "exportMeshesRequest." + error
      }
    }
    if (
      message.textureRequest != null &&
      message.hasOwnProperty("textureRequest")
    ) {
      if (properties.msg === 1) return "msg: multiple values"
      properties.msg = 1
      {
        var error = $root.TextureRequest.verify(message.textureRequest)
        if (error) return "textureRequest." + error
      }
    }
    if (
      message.elementTooltipRequest != null &&
      message.hasOwnProperty("elementTooltipRequest")
    ) {
      if (properties.msg === 1) return "msg: multiple values"
      properties.msg = 1
      {
        var error = $root.ElementTooltipRequest.verify(
          message.elementTooltipRequest
        )
        if (error) return "elementTooltipRequest." + error
      }
    }
    if (
      message.projectExtentsRequest != null &&
      message.hasOwnProperty("projectExtentsRequest")
    ) {
      if (properties.msg === 1) return "msg: multiple values"
      properties.msg = 1
      {
        var error = $root.ProjectExtentsRequest.verify(
          message.projectExtentsRequest
        )
        if (error) return "projectExtentsRequest." + error
      }
    }
    if (
      message.cameraViewsRequest != null &&
      message.hasOwnProperty("cameraViewsRequest")
    ) {
      if (properties.msg === 1) return "msg: multiple values"
      properties.msg = 1
      {
        var error = $root.CameraViewsRequest.verify(message.cameraViewsRequest)
        if (error) return "cameraViewsRequest." + error
      }
    }
    if (
      message.elementPropertiesRequest != null &&
      message.hasOwnProperty("elementPropertiesRequest")
    ) {
      if (properties.msg === 1) return "msg: multiple values"
      properties.msg = 1
      {
        var error = $root.ElementPropertiesRequest.verify(
          message.elementPropertiesRequest
        )
        if (error) return "elementPropertiesRequest." + error
      }
    }
    return null
  }
  ...
  RequestWrapper.fromObject = function fromObject(object) {
    if (object instanceof $root.RequestWrapper) return object
    ...
    if (object.selectElementIdsRequest != null) {
      if (typeof object.selectElementIdsRequest !== "object")
        throw TypeError(
          ".RequestWrapper.selectElementIdsRequest: object expected"
        )
      message.selectElementIdsRequest =
        $root.SelectElementIdsRequest.fromObject(object.selectElementIdsRequest)
    }
    if (object.exportMeshesRequest != null) {
      ...
      message.exportMeshesRequest = $root.ExportMeshesRequest.fromObject(
        object.exportMeshesRequest
      )
    }
    if (object.textureRequest != null) {
      ...
      message.textureRequest = $root.TextureRequest.fromObject(
        object.textureRequest
      )
    }
    if (object.elementTooltipRequest != null) {
      if (typeof object.elementTooltipRequest !== "object")
        throw TypeError(
          ".RequestWrapper.elementTooltipRequest: object expected"
        )
      message.elementTooltipRequest = $root.ElementTooltipRequest.fromObject(
        object.elementTooltipRequest
      )
    }
    if (object.projectExtentsRequest != null) {
      if (typeof object.projectExtentsRequest !== "object")
        throw TypeError(
          ".RequestWrapper.projectExtentsRequest: object expected"
        )
      message.projectExtentsRequest = $root.ProjectExtentsRequest.fromObject(
        object.projectExtentsRequest
      )
    }
    if (object.cameraViewsRequest != null) {
      ...
      message.cameraViewsRequest = $root.CameraViewsRequest.fromObject(
        object.cameraViewsRequest
      )
    }
    if (object.elementPropertiesRequest != null) {
      if (typeof object.elementPropertiesRequest !== "object")
        throw TypeError(
          ".RequestWrapper.elementPropertiesRequest: object expected"
        )
      message.elementPropertiesRequest =
        $root.ElementPropertiesRequest.fromObject(
          object.elementPropertiesRequest
        )
    }
    return message
  }
  ...
  RequestWrapper.toObject = function toObject(message, options) {
    ...
    if (
      ...
      object.selectElementIdsRequest = $root.SelectElementIdsRequest.toObject(
        message.selectElementIdsRequest,
        options
      )
      if (options.oneofs) object.msg = "selectElementIdsRequest"
    }
    if (
      message.exportMeshesRequest != null &&
      message.hasOwnProperty("exportMeshesRequest")
    ) {
      object.exportMeshesRequest = $root.ExportMeshesRequest.toObject(
        message.exportMeshesRequest,
        options
      )
      if (options.oneofs) object.msg = "exportMeshesRequest"
    }
    if (
      message.textureRequest != null &&
      message.hasOwnProperty("textureRequest")
    ) {
      object.textureRequest = $root.TextureRequest.toObject(
        message.textureRequest,
        options
      )
      if (options.oneofs) object.msg = "textureRequest"
    }
    if (
      message.elementTooltipRequest != null &&
      message.hasOwnProperty("elementTooltipRequest")
    ) {
      object.elementTooltipRequest = $root.ElementTooltipRequest.toObject(
        message.elementTooltipRequest,
        options
      )
      if (options.oneofs) object.msg = "elementTooltipRequest"
    }
    if (
      message.projectExtentsRequest != null &&
      message.hasOwnProperty("projectExtentsRequest")
    ) {
      object.projectExtentsRequest = $root.ProjectExtentsRequest.toObject(
        message.projectExtentsRequest,
        options
      )
      if (options.oneofs) object.msg = "projectExtentsRequest"
    }
    if (
      message.cameraViewsRequest != null &&
      message.hasOwnProperty("cameraViewsRequest")
    ) {
      object.cameraViewsRequest = $root.CameraViewsRequest.toObject(
        message.cameraViewsRequest,
        options
      )
      if (options.oneofs) object.msg = "cameraViewsRequest"
    }
    if (
      message.elementPropertiesRequest != null &&
      message.hasOwnProperty("elementPropertiesRequest")
    ) {
      object.elementPropertiesRequest = $root.ElementPropertiesRequest.toObject(
        message.elementPropertiesRequest,
        options
      )
      if (options.oneofs) object.msg = "elementPropertiesRequest"
    }
    return object
  }
...
$root.ReplyWrapper = (function () {
  ...
  Object.defineProperty(ReplyWrapper.prototype, "msg", {
    get: $util.oneOfGetter(
      ($oneOfFields = [
        "selectElementIdsReply",
        "exportMeshesReply",
        "textureReply",
        "elementTooltipReply",
        "projectExtentsReply",
        "cameraViewsReply",
        "elementPropertiesReply",
      ])
    ),
    set: $util.oneOfSetter($oneOfFields),
  })
  ...
  ReplyWrapper.encode = function encode(message, writer) {
    ...
    if (
      ...
      writer.uint32(/* id 1, wireType 0 =*/ 8).uint32(message.requestId)
    if (
      message.requestHasMoreReplies != null &&
      Object.hasOwnProperty.call(message, "requestHasMoreReplies")
    )
      writer
        .uint32(/* id 2, wireType 0 =*/ 16)
        .bool(message.requestHasMoreReplies)
    if (
      message.selectElementIdsReply != null &&
      Object.hasOwnProperty.call(message, "selectElementIdsReply")
    )
      $root.SelectElementIdsReply.encode(
        message.selectElementIdsReply,
        writer.uint32(/* id 3, wireType 2 =*/ 26).fork()
      ).ldelim()
    if (
      message.exportMeshesReply != null &&
      Object.hasOwnProperty.call(message, "exportMeshesReply")
    )
      $root.ExportMeshesReply.encode(
        message.exportMeshesReply,
        writer.uint32(/* id 4, wireType 2 =*/ 34).fork()
      ).ldelim()
    if (
      message.textureReply != null &&
      Object.hasOwnProperty.call(message, "textureReply")
    )
      $root.TextureReply.encode(
        message.textureReply,
        writer.uint32(/* id 5, wireType 2 =*/ 42).fork()
      ).ldelim()
    if (
      message.elementTooltipReply != null &&
      Object.hasOwnProperty.call(message, "elementTooltipReply")
    )
      $root.ElementTooltipReply.encode(
        message.elementTooltipReply,
        writer.uint32(/* id 6, wireType 2 =*/ 50).fork()
      ).ldelim()
    if (
      message.projectExtentsReply != null &&
      Object.hasOwnProperty.call(message, "projectExtentsReply")
    )
      $root.ProjectExtentsReply.encode(
        message.projectExtentsReply,
        writer.uint32(/* id 7, wireType 2 =*/ 58).fork()
      ).ldelim()
    if (
      message.cameraViewsReply != null &&
      Object.hasOwnProperty.call(message, "cameraViewsReply")
    )
      $root.CameraViewsReply.encode(
        message.cameraViewsReply,
        writer.uint32(/* id 8, wireType 2 =*/ 66).fork()
      ).ldelim()
    if (
      message.elementPropertiesReply != null &&
      Object.hasOwnProperty.call(message, "elementPropertiesReply")
    )
      $root.ElementPropertiesReply.encode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break
        case 3:
          message.selectElementIdsReply = $root.SelectElementIdsReply.decode(
            reader,
            reader.uint32()
          )
          break
        case 4:
          message.exportMeshesReply = $root.ExportMeshesReply.decode(
            reader,
            reader.uint32()
          )
          break
        case 5:
          message.textureReply = $root.TextureReply.decode(
            reader,
            reader.uint32()
          )
          break
        case 6:
          message.elementTooltipReply = $root.ElementTooltipReply.decode(
            reader,
            reader.uint32()
          )
          break
        case 7:
          message.projectExtentsReply = $root.ProjectExtentsReply.decode(
            reader,
            reader.uint32()
          )
          break
        case 8:
          message.cameraViewsReply = $root.CameraViewsReply.decode(
            reader,
            reader.uint32()
          )
          break
        case 9:
          message.elementPropertiesReply = $root.ElementPropertiesReply.decode(
            reader,
            reader.uint32()
          )
          break
  ...
  ReplyWrapper.verify = function verify(message) {
    ...
    if (
      message.requestHasMoreReplies != null &&
      message.hasOwnProperty("requestHasMoreReplies")
    )
      if (typeof message.requestHasMoreReplies !== "boolean")
        return "requestHasMoreReplies: boolean expected"
    if (
      message.selectElementIdsReply != null &&
      message.hasOwnProperty("selectElementIdsReply")
    ) {
      properties.msg = 1
      {
        var error = $root.SelectElementIdsReply.verify(
          message.selectElementIdsReply
        )
        if (error) return "selectElementIdsReply." + error
      }
    }
    if (
      message.exportMeshesReply != null &&
      message.hasOwnProperty("exportMeshesReply")
    ) {
      if (properties.msg === 1) return "msg: multiple values"
      properties.msg = 1
      {
        var error = $root.ExportMeshesReply.verify(message.exportMeshesReply)
        if (error) return "exportMeshesReply." + error
      }
    }
    if (
      message.textureReply != null &&
      message.hasOwnProperty("textureReply")
    ) {
      if (properties.msg === 1) return "msg: multiple values"
      properties.msg = 1
      {
        var error = $root.TextureReply.verify(message.textureReply)
        if (error) return "textureReply." + error
      }
    }
    if (
      message.elementTooltipReply != null &&
      message.hasOwnProperty("elementTooltipReply")
    ) {
      if (properties.msg === 1) return "msg: multiple values"
      properties.msg = 1
      {
        var error = $root.ElementTooltipReply.verify(
          message.elementTooltipReply
        )
        if (error) return "elementTooltipReply." + error
      }
    }
    if (
      message.projectExtentsReply != null &&
      message.hasOwnProperty("projectExtentsReply")
    ) {
      if (properties.msg === 1) return "msg: multiple values"
      properties.msg = 1
      {
        var error = $root.ProjectExtentsReply.verify(
          message.projectExtentsReply
        )
        if (error) return "projectExtentsReply." + error
      }
    }
    if (
      message.cameraViewsReply != null &&
      message.hasOwnProperty("cameraViewsReply")
    ) {
      if (properties.msg === 1) return "msg: multiple values"
      properties.msg = 1
      {
        var error = $root.CameraViewsReply.verify(message.cameraViewsReply)
        if (error) return "cameraViewsReply." + error
      }
    }
    if (
      message.elementPropertiesReply != null &&
      message.hasOwnProperty("elementPropertiesReply")
    ) {
      if (properties.msg === 1) return "msg: multiple values"
      properties.msg = 1
      {
        var error = $root.ElementPropertiesReply.verify(
          message.elementPropertiesReply
        )
        if (error) return "elementPropertiesReply." + error
      }
    }
    return null
  }
  ...
  ReplyWrapper.fromObject = function fromObject(object) {
    if (object instanceof $root.ReplyWrapper) return object
    ...
    if (object.selectElementIdsReply != null) {
      ...
      message.selectElementIdsReply = $root.SelectElementIdsReply.fromObject(
        object.selectElementIdsReply
      )
    }
    if (object.exportMeshesReply != null) {
      ...
      message.exportMeshesReply = $root.ExportMeshesReply.fromObject(
        object.exportMeshesReply
      )
    }
    ...
    if (object.elementTooltipReply != null) {
      ...
      message.elementTooltipReply = $root.ElementTooltipReply.fromObject(
        object.elementTooltipReply
      )
    }
    if (object.projectExtentsReply != null) {
      ...
      message.projectExtentsReply = $root.ProjectExtentsReply.fromObject(
        object.projectExtentsReply
      )
    }
    if (object.cameraViewsReply != null) {
      ...
      message.cameraViewsReply = $root.CameraViewsReply.fromObject(
        object.cameraViewsReply
      )
    }
    if (object.elementPropertiesReply != null) {
      ...
      message.elementPropertiesReply = $root.ElementPropertiesReply.fromObject(
        object.elementPropertiesReply
      )
    }
    return message
  }
  ...
  ReplyWrapper.toObject = function toObject(message, options) {
    ...
    if (
      ...
      object.selectElementIdsReply = $root.SelectElementIdsReply.toObject(
        message.selectElementIdsReply,
        options
      )
      if (options.oneofs) object.msg = "selectElementIdsReply"
    }
    if (
      message.exportMeshesReply != null &&
      message.hasOwnProperty("exportMeshesReply")
    ) {
      object.exportMeshesReply = $root.ExportMeshesReply.toObject(
        message.exportMeshesReply,
        options
      )
      if (options.oneofs) object.msg = "exportMeshesReply"
    }
    if (
      message.textureReply != null &&
      message.hasOwnProperty("textureReply")
    ) {
      object.textureReply = $root.TextureReply.toObject(
        message.textureReply,
        options
      )
      if (options.oneofs) object.msg = "textureReply"
    }
    if (
      message.elementTooltipReply != null &&
      message.hasOwnProperty("elementTooltipReply")
    ) {
      object.elementTooltipReply = $root.ElementTooltipReply.toObject(
        message.elementTooltipReply,
        options
      )
      if (options.oneofs) object.msg = "elementTooltipReply"
    }
    if (
      message.projectExtentsReply != null &&
      message.hasOwnProperty("projectExtentsReply")
    ) {
      object.projectExtentsReply = $root.ProjectExtentsReply.toObject(
        message.projectExtentsReply,
        options
      )
      if (options.oneofs) object.msg = "projectExtentsReply"
    }
    if (
      message.cameraViewsReply != null &&
      message.hasOwnProperty("cameraViewsReply")
    ) {
      object.cameraViewsReply = $root.CameraViewsReply.toObject(
        message.cameraViewsReply,
        options
      )
      if (options.oneofs) object.msg = "cameraViewsReply"
    }
    if (
      message.elementPropertiesReply != null &&
      message.hasOwnProperty("elementPropertiesReply")
    ) {
      object.elementPropertiesReply = $root.ElementPropertiesReply.toObject(
        message.elementPropertiesReply,
        options
      )
      if (options.oneofs) object.msg = "elementPropertiesReply"
    }
    return object
  }
...
$root.SelectElementIdsRequest = (function () {
  ...
  SelectElementIdsRequest.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create()
    if (
      message.selectFilter != null &&
      Object.hasOwnProperty.call(message, "selectFilter")
    )
   ...
   * @returns {$protobuf.Writer} Writer
   */
  SelectElementIdsRequest.encodeDelimited = function encodeDelimited(
    message,
    writer
  ) {
    return this.encode(message, writer).ldelim()
  ...
  SelectElementIdsRequest.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.SelectElementIdsRequest()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  SelectElementIdsRequest.fromObject = function fromObject(object) {
    if (object instanceof $root.SelectElementIdsRequest) return object
  ...
  SelectElementIdsRequest.toObject = function toObject(message, options) {
    if (!options) options = {}
    var object = {}
    if (options.defaults) object.selectFilter = ""
    if (message.selectFilter != null && message.hasOwnProperty("selectFilter"))
...
$root.SelectElementIdsReply = (function () {
   ...
   * @returns {$protobuf.Writer} Writer
   */
  SelectElementIdsReply.encodeDelimited = function encodeDelimited(
    message,
    writer
  ) {
    return this.encode(message, writer).ldelim()
  ...
  SelectElementIdsReply.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.SelectElementIdsReply()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  SelectElementIdsReply.fromObject = function fromObject(object) {
    if (object instanceof $root.SelectElementIdsReply) return object
  ...
  SelectElementIdsReply.toObject = function toObject(message, options) {
    if (!options) options = {}
    var object = {}
    if (options.arrays || options.defaults) object.elementIds = []
    if (message.elementIds && message.elementIds.length) {
      object.elementIds = []
...
$root.ExportMeshesRequest = (function () {
  ...
  ExportMeshesRequest.encode = function encode(message, writer) {
    ...
    if (message.elementIds != null && message.elementIds.length)
      for (var i = 0; i < message.elementIds.length; ++i)
        writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.elementIds[i])
    if (
      message.chordTol != null &&
      Object.hasOwnProperty.call(message, "chordTol")
    )
   ...
   * @returns {$protobuf.Writer} Writer
   */
  ExportMeshesRequest.encodeDelimited = function encodeDelimited(
    message,
    writer
  ) {
    return this.encode(message, writer).ldelim()
  ...
  ExportMeshesRequest.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.ExportMeshesRequest()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  ExportMeshesRequest.fromObject = function fromObject(object) {
    if (object instanceof $root.ExportMeshesRequest) return object
    ...
    if (object.chordTol != null) message.chordTol = Number(object.chordTol)
    return message
  }
  ...
  ExportMeshesRequest.toObject = function toObject(message, options) {
    ...
    var object = {}
    if (options.arrays || options.defaults) object.elementIds = []
    if (options.defaults) object.chordTol = 0
    if (message.elementIds && message.elementIds.length) {
      object.elementIds = []
      for (var j = 0; j < message.elementIds.length; ++j)
        object.elementIds[j] = message.elementIds[j]
    ...
    if (message.chordTol != null && message.hasOwnProperty("chordTol"))
      object.chordTol =
        options.json && !isFinite(message.chordTol)
          ? String(message.chordTol)
          : message.chordTol
    return object
  }
...
$root.ExportMeshesReply = (function () {
  ...
  ExportMeshesReply.encode = function encode(message, writer) {
    ...
    if (
      message.indexCount != null &&
      Object.hasOwnProperty.call(message, "indexCount")
    )
      writer.uint32(/* id 3, wireType 0 =*/ 24).uint32(message.indexCount)
    if (
      message.vertexCount != null &&
      Object.hasOwnProperty.call(message, "vertexCount")
    )
      writer.uint32(/* id 4, wireType 0 =*/ 32).uint32(message.vertexCount)
    if (
      message.meshData != null &&
      Object.hasOwnProperty.call(message, "meshData")
    )
      writer.uint32(/* id 5, wireType 2 =*/ 42).bytes(message.meshData)
    if (
      message.textureId != null &&
      Object.hasOwnProperty.call(message, "textureId")
    )
   ...
   * @returns {$protobuf.Writer} Writer
   */
  ExportMeshesReply.encodeDelimited = function encodeDelimited(
    message,
    writer
  ) {
    return this.encode(message, writer).ldelim()
  ...
  ExportMeshesReply.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.ExportMeshesReply()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  ExportMeshesReply.verify = function verify(message) {
    ...
    if (message.meshData != null && message.hasOwnProperty("meshData"))
      if (
        !(
          (message.meshData && typeof message.meshData.length === "number") ||
          $util.isString(message.meshData)
        )
      )
  ...
  ExportMeshesReply.fromObject = function fromObject(object) {
    if (object instanceof $root.ExportMeshesReply) return object
    ...
    if (object.indexCount != null) message.indexCount = object.indexCount >>> 0
    ...
    if (object.meshData != null)
      if (typeof object.meshData === "string")
        $util.base64.decode(
          object.meshData,
          (message.meshData = $util.newBuffer(
            $util.base64.length(object.meshData)
          )),
          0
        )
      else if (object.meshData.length) message.meshData = object.meshData
    if (object.textureId != null) message.textureId = String(object.textureId)
    return message
  }
  ...
  ExportMeshesReply.toObject = function toObject(message, options) {
    ...
    if (options.defaults) {
      ...
      if (options.bytes === String) object.meshData = ""
      else {
        object.meshData = []
    ...
    if (message.meshData != null && message.hasOwnProperty("meshData"))
      object.meshData =
        options.bytes === String
          ? $util.base64.encode(message.meshData, 0, message.meshData.length)
          : options.bytes === Array
          ? Array.prototype.slice.call(message.meshData)
          : message.meshData
    if (message.textureId != null && message.hasOwnProperty("textureId"))
...
$root.TextureRequest = (function () {
  ...
  TextureRequest.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.TextureRequest()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  TextureRequest.fromObject = function fromObject(object) {
    if (object instanceof $root.TextureRequest) return object
  ...
  TextureRequest.toObject = function toObject(message, options) {
    if (!options) options = {}
    var object = {}
    if (options.defaults) object.textureId = ""
    if (message.textureId != null && message.hasOwnProperty("textureId"))
      object.textureId = message.textureId
    return object
  }
...
$root.TextureReply = (function () {
  ...
  TextureReply.encode = function encode(message, writer) {
    ...
    if (
      ...
      writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.textureId)
    if (
      message.textureData != null &&
      Object.hasOwnProperty.call(message, "textureData")
    )
  ...
  TextureReply.verify = function verify(message) {
    ...
    if (message.textureData != null && message.hasOwnProperty("textureData"))
      if (
        !(
          (message.textureData &&
            typeof message.textureData.length === "number") ||
          $util.isString(message.textureData)
        )
      )
  ...
  TextureReply.fromObject = function fromObject(object) {
    if (object instanceof $root.TextureReply) return object
    ...
    if (object.textureData != null)
      if (typeof object.textureData === "string")
        $util.base64.decode(
          object.textureData,
          (message.textureData = $util.newBuffer(
            $util.base64.length(object.textureData)
          )),
          0
        )
  ...
  TextureReply.toObject = function toObject(message, options) {
    ...
    if (options.defaults) {
      object.textureId = ""
      if (options.bytes === String) object.textureData = ""
      else {
        object.textureData = []
        if (options.bytes !== Array)
      ...
      object.textureData =
        options.bytes === String
          ? $util.base64.encode(
              message.textureData,
              0,
              message.textureData.length
            )
          : options.bytes === Array
          ? Array.prototype.slice.call(message.textureData)
          : message.textureData
    return object
  }
...
$root.ElementTooltipRequest = (function () {
   ...
   * @returns {$protobuf.Writer} Writer
   */
  ElementTooltipRequest.encodeDelimited = function encodeDelimited(
    message,
    writer
  ) {
    return this.encode(message, writer).ldelim()
  ...
  ElementTooltipRequest.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.ElementTooltipRequest()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  ElementTooltipRequest.fromObject = function fromObject(object) {
    if (object instanceof $root.ElementTooltipRequest) return object
  ...
  ElementTooltipRequest.toObject = function toObject(message, options) {
    if (!options) options = {}
    var object = {}
    if (options.defaults) object.elementId = ""
    if (message.elementId != null && message.hasOwnProperty("elementId"))
      object.elementId = message.elementId
    return object
  }
...
$root.ElementTooltipReply = (function () {
   ...
   * @returns {$protobuf.Writer} Writer
   */
  ElementTooltipReply.encodeDelimited = function encodeDelimited(
    message,
    writer
  ) {
    return this.encode(message, writer).ldelim()
  ...
  ElementTooltipReply.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.ElementTooltipReply()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  ElementTooltipReply.verify = function verify(message) {
    ...
    if (
      message.categoryLabel != null &&
      message.hasOwnProperty("categoryLabel")
    )
  ...
  ElementTooltipReply.fromObject = function fromObject(object) {
    if (object instanceof $root.ElementTooltipReply) return object
...
$root.ProjectExtentsRequest = (function () {
   ...
   * @returns {$protobuf.Writer} Writer
   */
  ProjectExtentsRequest.encodeDelimited = function encodeDelimited(
    message,
    writer
  ) {
    return this.encode(message, writer).ldelim()
  ...
  ProjectExtentsRequest.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.ProjectExtentsRequest()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        default:
  ...
  ProjectExtentsRequest.fromObject = function fromObject(object) {
    if (object instanceof $root.ProjectExtentsRequest) return object
...
$root.ProjectExtentsReply = (function () {
   ...
   * @returns {$protobuf.Writer} Writer
   */
  ProjectExtentsReply.encodeDelimited = function encodeDelimited(
    message,
    writer
  ) {
    return this.encode(message, writer).ldelim()
  ...
  ProjectExtentsReply.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.ProjectExtentsReply()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  ProjectExtentsReply.verify = function verify(message) {
    ...
    if (message.minX != null && message.hasOwnProperty("minX"))
      if (typeof message.minX !== "number") return "minX: number expected"
    if (message.minY != null && message.hasOwnProperty("minY"))
      if (typeof message.minY !== "number") return "minY: number expected"
    if (message.minZ != null && message.hasOwnProperty("minZ"))
      if (typeof message.minZ !== "number") return "minZ: number expected"
    if (message.maxX != null && message.hasOwnProperty("maxX"))
      if (typeof message.maxX !== "number") return "maxX: number expected"
    if (message.maxY != null && message.hasOwnProperty("maxY"))
      if (typeof message.maxY !== "number") return "maxY: number expected"
    if (message.maxZ != null && message.hasOwnProperty("maxZ"))
      if (typeof message.maxZ !== "number") return "maxZ: number expected"
    return null
  }
  ...
  ProjectExtentsReply.fromObject = function fromObject(object) {
    if (object instanceof $root.ProjectExtentsReply) return object
    var message = new $root.ProjectExtentsReply()
    if (object.minX != null) message.minX = Number(object.minX)
    if (object.minY != null) message.minY = Number(object.minY)
    if (object.minZ != null) message.minZ = Number(object.minZ)
    if (object.maxX != null) message.maxX = Number(object.maxX)
    if (object.maxY != null) message.maxY = Number(object.maxY)
    if (object.maxZ != null) message.maxZ = Number(object.maxZ)
    return message
  }
  ...
  ProjectExtentsReply.toObject = function toObject(message, options) {
    ...
    if (message.minX != null && message.hasOwnProperty("minX"))
      object.minX =
        options.json && !isFinite(message.minX)
          ? String(message.minX)
          : message.minX
    if (message.minY != null && message.hasOwnProperty("minY"))
      object.minY =
        options.json && !isFinite(message.minY)
          ? String(message.minY)
          : message.minY
    if (message.minZ != null && message.hasOwnProperty("minZ"))
      object.minZ =
        options.json && !isFinite(message.minZ)
          ? String(message.minZ)
          : message.minZ
    if (message.maxX != null && message.hasOwnProperty("maxX"))
      object.maxX =
        options.json && !isFinite(message.maxX)
          ? String(message.maxX)
          : message.maxX
    if (message.maxY != null && message.hasOwnProperty("maxY"))
      object.maxY =
        options.json && !isFinite(message.maxY)
          ? String(message.maxY)
          : message.maxY
    if (message.maxZ != null && message.hasOwnProperty("maxZ"))
      object.maxZ =
        options.json && !isFinite(message.maxZ)
          ? String(message.maxZ)
          : message.maxZ
    return object
  }
...
$root.CameraViewsRequest = (function () {
   ...
   * @returns {$protobuf.Writer} Writer
   */
  CameraViewsRequest.encodeDelimited = function encodeDelimited(
    message,
    writer
  ) {
    return this.encode(message, writer).ldelim()
  ...
  CameraViewsRequest.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.CameraViewsRequest()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        default:
  ...
  CameraViewsRequest.fromObject = function fromObject(object) {
    if (object instanceof $root.CameraViewsRequest) return object
...
$root.CameraViewsReply = (function () {
  ...
  CameraViewsReply.encode = function encode(message, writer) {
    ...
    if (
      ...
      writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.elementId)
    if (
      message.displayLabel != null &&
      Object.hasOwnProperty.call(message, "displayLabel")
    )
      writer.uint32(/* id 2, wireType 2 =*/ 18).string(message.displayLabel)
    if (
      message.eyePointX != null &&
      Object.hasOwnProperty.call(message, "eyePointX")
    )
      writer.uint32(/* id 3, wireType 1 =*/ 25).double(message.eyePointX)
    if (
      message.eyePointY != null &&
      Object.hasOwnProperty.call(message, "eyePointY")
    )
      writer.uint32(/* id 4, wireType 1 =*/ 33).double(message.eyePointY)
    if (
      message.eyePointZ != null &&
      Object.hasOwnProperty.call(message, "eyePointZ")
    )
  ...
  CameraViewsReply.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.CameraViewsReply()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  CameraViewsReply.verify = function verify(message) {
    ...
    if (message.yaw != null && message.hasOwnProperty("yaw"))
      if (typeof message.yaw !== "number") return "yaw: number expected"
    if (message.pitch != null && message.hasOwnProperty("pitch"))
      if (typeof message.pitch !== "number") return "pitch: number expected"
  ...
  CameraViewsReply.fromObject = function fromObject(object) {
    if (object instanceof $root.CameraViewsReply) return object
    var message = new $root.CameraViewsReply()
    if (object.elementId != null) message.elementId = String(object.elementId)
    if (object.displayLabel != null)
      message.displayLabel = String(object.displayLabel)
    if (object.eyePointX != null) message.eyePointX = Number(object.eyePointX)
    if (object.eyePointY != null) message.eyePointY = Number(object.eyePointY)
    if (object.eyePointZ != null) message.eyePointZ = Number(object.eyePointZ)
    if (object.yaw != null) message.yaw = Number(object.yaw)
    if (object.pitch != null) message.pitch = Number(object.pitch)
  ...
  CameraViewsReply.toObject = function toObject(message, options) {
    ...
    if (message.eyePointX != null && message.hasOwnProperty("eyePointX"))
      object.eyePointX =
        options.json && !isFinite(message.eyePointX)
          ? String(message.eyePointX)
          : message.eyePointX
    if (message.eyePointY != null && message.hasOwnProperty("eyePointY"))
      object.eyePointY =
        options.json && !isFinite(message.eyePointY)
          ? String(message.eyePointY)
          : message.eyePointY
    if (message.eyePointZ != null && message.hasOwnProperty("eyePointZ"))
      object.eyePointZ =
        options.json && !isFinite(message.eyePointZ)
          ? String(message.eyePointZ)
          : message.eyePointZ
    if (message.yaw != null && message.hasOwnProperty("yaw"))
      object.yaw =
        options.json && !isFinite(message.yaw)
          ? String(message.yaw)
          : message.yaw
    if (message.pitch != null && message.hasOwnProperty("pitch"))
      object.pitch =
        options.json && !isFinite(message.pitch)
...
$root.ElementPropertiesRequest = (function () {
   ...
   * @returns {$protobuf.Writer} Writer
   */
  ElementPropertiesRequest.encodeDelimited = function encodeDelimited(
    message,
    writer
  ) {
    return this.encode(message, writer).ldelim()
  ...
  ElementPropertiesRequest.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.ElementPropertiesRequest()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  ElementPropertiesRequest.fromObject = function fromObject(object) {
    if (object instanceof $root.ElementPropertiesRequest) return object
...
$root.ElementPropertiesReply = (function () {
  ...
  ElementPropertiesReply.encode = function encode(message, writer) {
    ...
    if (message.root != null && Object.hasOwnProperty.call(message, "root"))
      $root.ElementPropertiesReplyEntry.encode(
        message.root,
   ...
   * @returns {$protobuf.Writer} Writer
   */
  ElementPropertiesReply.encodeDelimited = function encodeDelimited(
    message,
    writer
  ) {
    return this.encode(message, writer).ldelim()
  ...
  ElementPropertiesReply.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.ElementPropertiesReply()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
          message.root = $root.ElementPropertiesReplyEntry.decode(
            reader,
            reader.uint32()
          )
          break
  ...
  ElementPropertiesReply.fromObject = function fromObject(object) {
    if (object instanceof $root.ElementPropertiesReply) return object
  ...
  ElementPropertiesReply.toObject = function toObject(message, options) {
    if (!options) options = {}
    var object = {}
    if (options.defaults) object.root = null
    if (message.root != null && message.hasOwnProperty("root"))
      object.root = $root.ElementPropertiesReplyEntry.toObject(
        message.root,
        options
      )
    return object
...
$root.ElementPropertiesReplyEntry = (function () {
   ...
   * @returns {$protobuf.Writer} Writer
   */
  ElementPropertiesReplyEntry.encodeDelimited = function encodeDelimited(
    message,
    writer
  ) {
    return this.encode(message, writer).ldelim()
  ...
  ElementPropertiesReplyEntry.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.ElementPropertiesReplyEntry()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
        ...
        case 3:
          ...
          message.children.push(
            $root.ElementPropertiesReplyEntry.decode(reader, reader.uint32())
          )
          break
        default:
          reader.skipType(tag & 7)
   ...
   * @throws {$protobuf.util.ProtocolError} If required fields are missing
   */
  ElementPropertiesReplyEntry.decodeDelimited = function decodeDelimited(
    reader
  ) {
    if (!(reader instanceof $Reader)) reader = new $Reader(reader)
    return this.decode(reader, reader.uint32())
  ...
  ElementPropertiesReplyEntry.verify = function verify(message) {
    ...
    if (message.children != null && message.hasOwnProperty("children")) {
      ...
      for (var i = 0; i < message.children.length; ++i) {
        var error = $root.ElementPropertiesReplyEntry.verify(
          message.children[i]
        )
  ...
  ElementPropertiesReplyEntry.fromObject = function fromObject(object) {
    if (object instanceof $root.ElementPropertiesReplyEntry) return object
    ...
    if (object.children) {
      ...
      for (var i = 0; i < object.children.length; ++i) {
        if (typeof object.children[i] !== "object")
          throw TypeError(
            ".ElementPropertiesReplyEntry.children: object expected"
          )
        message.children[i] = $root.ElementPropertiesReplyEntry.fromObject(
          object.children[i]
        )
      }
    }
  ...
  ElementPropertiesReplyEntry.toObject = function toObject(message, options) {
    ...
    if (message.children && message.children.length) {
      ...
      for (var j = 0; j < message.children.length; ++j)
        object.children[j] = $root.ElementPropertiesReplyEntry.toObject(
          message.children[j],
          options
        )
    }
